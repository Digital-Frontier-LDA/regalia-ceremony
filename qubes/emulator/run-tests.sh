...
say "ENTROPY SEED — dice + HSM + OS are always mixed, and no entropy file survives"
"$HERE/tests/test-entropy-seed.sh" || suite_failed "test-entropy-seed.sh"
...
"$HERE/tests/test-nitrokey-acceptance.sh" || suite_failed "test-nitrokey-acceptance.sh"
